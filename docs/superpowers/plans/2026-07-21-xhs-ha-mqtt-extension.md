...
- [x] **Step 1: Add failing release-package assertions**
...
- [x] **Step 3: Implement a dependency-free ZIP store writer**
...
- [x] **Step 4: Implement syntax discovery instead of a hard-coded file list**
...
- [x] **Step 5: Update release scanning**
...
- [x] **Step 6: Generate twice and verify GREEN**
...
- [x] **Step 7: Commit packaging and release artifacts**
